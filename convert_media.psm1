# common logic for file conversion

function Convert-Media($InputFormats, $OutputFormat, $Identifier, $Command, $InputDirectory)
{
    # input and output directories
    $InputNameNormalized = $InputDirectory.TrimEnd('\','/').Replace('./','').Replace('.\','')
    $InputRoot = "./" + $InputNameNormalized
    $OutputRoot = $InputRoot + "_" + $OutputFormat + "_" + $Identifier

    # formats to take as input
    $FormatsFilePath = Join-Path $PSScriptRoot $InputFormats
